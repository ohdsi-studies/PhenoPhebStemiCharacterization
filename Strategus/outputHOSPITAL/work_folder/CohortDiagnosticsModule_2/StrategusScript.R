...
source("Main.R")
jobContext <- readRDS("/home/mbrand2/PhenoPheb_STEMI_Characterization_new/Strategus/output/work_folder/CohortDiagnosticsModule_2/jobContext.rds")
...
writeLines("done", "/home/mbrand2/PhenoPheb_STEMI_Characterization_new/Strategus/output/results_folder/CohortDiagnosticsModule_2/done")
